...
```
node build --copy; site/vendor/bin/phpunit site/tests/unit/Espo/Modules/LearnScheduledJobs
```
...
```
(cd site && vendor/bin/phpunit tests/integration/Espo/Modules/LearnScheduledJobs)
```
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/LearnScheduledJobs`
* `site/tests/integration/Espo/Modules/LearnScheduledJobs`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/LearnScheduledJobs/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/LearnScheduledJobs/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/learn-scheduled-jobs/lib/init.js"
        ]
    }
    ```
